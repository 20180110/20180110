<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"D:\WWW\20180110\public/../application/admin\view\company\add.html";i:1515574789;s:67:"D:\WWW\20180110\public/../application/admin\view\public\header.html";i:1515568287;s:65:"D:\WWW\20180110\public/../application/admin\view\public\menu.html";i:1516083802;s:65:"D:\WWW\20180110\public/../application/admin\view\public\foot.html";i:1516081591;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <form class="form-horizontal" method="post">
                            <fieldset>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="address">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">企业法人</label>
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="person">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input name="creatdate" type="text" class="input-xlarge datepicker" id="date01" value="">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input name="team" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" data-source=''>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input name="Police" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" data-source=''>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input name="Staff" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" data-source=''>
                                ...
                                <div class="control-group">业务往来危险品运输车辆
                                    <div class="controls">
                                        <input name="RelationTruck" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" data-source=''>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input name="Range" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" data-source=''>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="remark" id="" cols="100" rows="10"></textarea>
