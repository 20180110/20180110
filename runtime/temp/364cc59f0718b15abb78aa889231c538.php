<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"D:\WWW\20180110\public/../application/admin\view\truck\edit.html";i:1515579159;s:67:"D:\WWW\20180110\public/../application/admin\view\public\header.html";i:1515568287;s:65:"D:\WWW\20180110\public/../application/admin\view\public\menu.html";i:1515576000;s:65:"D:\WWW\20180110\public/../application/admin\view\public\foot.html";i:1515555601;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white edit"></i><span class="break"></span>车辆信息录入 </h2>
                        <div class="box-icon">
                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" method="post">
                            ...
                            <fieldset>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <select class="select" name="company" size="1" >
                                            ...
                                            <option value="<?php echo $vo['Id']; ?>" <?php if($vo['Id'] == $data['company']): ?>selected<?php endif; ?> ><?php echo $vo['name']; ?></option>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">所属挂车</label>
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" data-source='' name="truck" value="<?php echo $data['truck']; ?>">

                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">车身颜色</label>
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" data-source='' name="truckcolour" value="<?php echo $data['truckcolour']; ?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="file" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" data-source='' name="imgurl">
                                        <img src="/uploads/<?php echo $data['imgurl']; ?>" alt="" width="100px" height="50px">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">是否重点管理对象</label>
                                    <div class="controls">
                                        <select class="select" name="key" size="1" >
                                            <option value="1" <?php if(1 == $data['key']): ?>selected<?php endif; ?> >是</option>
                                            <option value="0" <?php if(2 == $data['key']): ?>selected<?php endif; ?>>否</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">车辆年检时间</label>
                                    <div class="controls">
                                        <input name="yearcheck" type="text" class="input-xlarge datepicker" id="text"  data-provide="typeahead" data-items="4" value="<?php echo date('Y-m-d',$data['yearcheck']); ?>">

                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">车辆保险情况</label>
                                    <div class="controls">
                                        <input name="Insurance" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" value="<?php echo $data['Insurance']; ?>">

                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">车辆违法状态</label>
                                    <div class="controls">
                                        <input name="Illegality" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" value="<?php echo $data['Insurance']; ?>">

                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">车辆所属驾驶员</label>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">出来那个所属押运员</label>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">是否本地车辆</label>
                                    <div class="controls">
                                        <select class="select" name="local" size="1" >
                                            <option value="1" <?php if(1 == $data['local']): ?>selected<?php endif; ?>>是</option>
                                            <option value="0" <?php if(0 == $data['local']): ?>selected<?php endif; ?>>否</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">常载介质种类</label>
                                    <div class="controls">
                                        <input name="medium" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" value="<?php echo $data['medium']; ?>">

                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">车辆轨迹</label>
                                    <div class="controls">
                                        <input name="Route" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" value="<?php echo $data['Route']; ?>">
