<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"D:\WWW\20180110\public/../application/admin\view\person\edit.html";i:1515580607;s:67:"D:\WWW\20180110\public/../application/admin\view\public\header.html";i:1515568287;s:65:"D:\WWW\20180110\public/../application/admin\view\public\menu.html";i:1515579356;s:65:"D:\WWW\20180110\public/../application/admin\view\public\foot.html";i:1515555601;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" method="post">
                            ...
                            <fieldset>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="name1" value="<?php echo $data['name1']; ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">性别</label>
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="Gender" value="<?php echo $data['Gender']; ?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="file" class="span6 typeahead" id="typeahead"  data-provide="typeahead" name="imgurl">
                                        <img src="/uploads/<?php echo $data['imgurl']; ?>" alt="" width="100px" height="50px">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">身份证号码</label>
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="card" value="<?php echo $data['card']; ?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input name="age" type="text" class="typeahead" id="date01" value="<?php echo $data['age']; ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">家庭住址</label>
                                    <div class="controls">
                                        <input name="address" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" data-source='' value="<?php echo $data['address']; ?>">

                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">婚姻</label>
                                    <div class="controls">
                                        <input name="marry" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" data-source='' value="<?php echo $data['marry']; ?>">

                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">驾驶证类型</label>
                                    <div class="controls">
                                        <input name="drivertype" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" data-source='' value="<?php echo $data['drivertype']; ?>">

                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">押运证</label>
                                    <div class="controls">
                                        <input name="Escortcard" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" data-source='' value="<?php echo $data['Escortcard']; ?>">

                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">是否重点管理对象</label>
                                    <div class="controls">
                                        <input name="key" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" data-source='' value="<?php echo $data['key']; ?>">

                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">常驾驶车辆</label>
                                    <div class="controls">
                                        <input name="truck" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" data-source='' value="<?php echo $data['truck']; ?>">

                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">常押运车辆</label>
                                    <div class="controls">
                                        <input name="EscortTruck" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" data-source='' value="<?php echo $data['EscortTruck']; ?>">
