            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white edit"></i><span class="break"></span>报备信息编辑 </h2>
                        <div class="box-icon">
                            ...
                            <fieldset>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="truckID" value="<?php echo $data['truckID']; ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="typeahead">所属货物属性</label>
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="goodskind" value="<?php echo $data['goodskind']; ?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="Medium" value="<?php echo $data['Medium']; ?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="Throughmode" value="<?php echo $data['Throughmode']; ?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input name="startdate" type="text" class="input-xlarge datepicker" id="date01" value="<?php echo date('Y-m-d',$data['startdate']); ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input name="contact" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" data-source='' value="<?php echo $data['contact']; ?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input name="area" type="text" class="span6 typeahead" id="text"  data-provide="typeahead" data-items="4" value="<?php echo $data['area']; ?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="select" name="company" size="1" >
                                            ...
                                            <option value="<?php echo $vo['Id']; ?>" <?php if($vo['Id'] == $data['company']): ?>selected<?php endif; ?>><?php echo $vo['person']; ?></option>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
                                </div>
